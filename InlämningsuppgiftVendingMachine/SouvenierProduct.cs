...
{
    public abstract class SouvenierProduct : IProduct
    {
        ...
        public void BuyProduct(List<SouvenierProduct> y)
        {
        ...
        {
            Console.WriteLine();
            Console.WriteLine($"                                    I am showing my {name} souvenier to my friends");
            Console.WriteLine();
        }
    }
}
